...
export function options_foreach(
  _function: OptionsFunc,
  user_data: object | null
): void;
...
export function options_get_range_string(
  option: string,
  value: string
): boolean;
...
export function options_set_range_string(
  option: string,
  value: string
): boolean;
