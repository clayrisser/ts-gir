...
export interface DataModel {
  ...
  export_to_file(format: DataModelIOFormat, file: string, cols: number[] | null, nb_cols: number, rows: number[] | null, nb_rows: number, options: Set): boolean;
  export_to_string(format: DataModelIOFormat, cols: number[] | null, nb_cols: number, rows: number[] | null, nb_rows: number, options: Set): string;
  freeze(): void;
  ...
  get_typed_value_at(col: number, row: number, expected_type: any, nullok: boolean): GObject.Value | null;
  ...
  import_from_model(from: any, overwrite: boolean, cols_trans: GLib.HashTable | null): boolean;
...
export class Connection extends GObject.Object {
  constructor(dsn: string, auth_string: string | null, options: ConnectionOptions);
  'auth-string': string;
  'cnc-string': string;
  dsn: string;
  ...
  async_statement_execute(stmt: Statement, params: Set | null, model_usage: StatementModelUsage, col_types: any[] | null, need_last_insert_row: boolean): number;
  batch_execute(batch: Batch, params: Set | null, model_usage: StatementModelUsage): GLib.SList;
  ...
  get_meta_store_data(meta_type: ConnectionMetaType, error: GLib.Error, nb_filters: number, ...args: any[]): any;
  ...
  insert_row_into_table(table: string, error: GLib.Error, ...args: any[]): boolean;
  insert_row_into_table_v(table: string, col_names: GLib.SList, values: GLib.SList): boolean;
  ...
  internal_set_provider_data(data: object | null, destroy_func: GLib.DestroyNotify): void;
  ...
  repetitive_statement_execute(rstmt: RepetitiveStatement, model_usage: StatementModelUsage, col_types: any[] | null, stop_on_error: boolean): GLib.SList;
  rollback_savepoint(name: string | null): boolean;
  rollback_transaction(name: string | null): boolean;
  statement_execute(stmt: Statement, params: Set | null, model_usage: StatementModelUsage, last_insert_row?: Set): GObject.Object;
  statement_execute_non_select(stmt: Statement, params: Set | null, last_insert_row?: Set): number;
  statement_execute_select(stmt: Statement, params: Set | null): any;
  statement_execute_select_full(stmt: Statement, params: Set | null, model_usage: StatementModelUsage, col_types: any[] | null): any;
  statement_execute_select_fullv(stmt: Statement, params: Set | null, model_usage: StatementModelUsage, error: GLib.Error, ...args: any[]): any;
  statement_prepare(stmt: Statement): boolean;
  statement_to_sql(stmt: Statement, params: Set | null, flags: StatementSqlFlag, params_used?: GLib.SList): string;
  supports_feature(feature: ConnectionFeature): boolean;
  update_meta_store(context: MetaContext | null): boolean;
  update_row_in_table(table: string, condition_column_name: string, condition_value: GObject.Value, error: GLib.Error, ...args: any[]): boolean;
  update_row_in_table_v(table: string, condition_column_name: string, condition_value: GObject.Value, col_names: GLib.SList, values: GLib.SList): boolean;
...
export class DataModelImport extends GObject.Object {
  ...
  clean_errors(): void;
  get_errors(): GLib.SList;
  static new_file(filename: string, random_access: boolean, options: Set | null): any;
  static new_mem(data: string, random_access: boolean, options: Set | null): any;
...
export class DataProxy extends GObject.Object {
  ...
  get_values(proxy_row: number, cols_index: number[], n_cols: number): GLib.SList;
  has_changed(): boolean;
...
export class Holder extends GObject.Object {
  ...
  is_valid(): boolean;
  is_valid_e(): boolean;
  set_attribute(attribute: string, value: GObject.Value, destroy: GLib.DestroyNotify): void;
...
export class MetaStore extends GObject.Object {
  ...
  declare_foreign_key(mstruct: MetaStruct | null, fk_name: string, catalog: string | null, schema: string | null, table: string, ref_catalog: string | null, ref_schema: string | null, ref_table: string, nb_cols: number, colnames: string[], ref_colnames: string[]): boolean;
  ...
  get_version(): number;
  modify(table_name: string, new_data: any | null, condition: string | null, error: GLib.Error | null, ...args: any[]): boolean;
  modify_v(table_name: string, new_data: any | null, condition: string | null, nvalues: number, value_names: string[], values: GObject.Value[]): boolean;
...
export class ServerOperation extends GObject.Object {
  ...
  get_node_info(path_format: string, ...args: any[]): ServerOperationNode | null;
  ...
  get_sql_identifier_at(cnc: Connection | null, prov: ServerProvider | null, path_format: string, ...args: any[]): string;
  get_sql_identifier_at_path(cnc: Connection | null, prov: ServerProvider | null, path: string): string;
  ...
  set_value_at(value: string | null, error: GLib.Error, path_format: string, ...args: any[]): boolean;
  ...
  static prepare_create_table(cnc: Connection, table_name: string, error: GLib.Error, ...args: any[]): ServerOperation | null;
...
export class ServerProvider extends GObject.Object {
  ...
  get_data_handler_default(cnc: Connection | null, type: any, dbms_type: string): any;
  ...
  handler_find(cnc: Connection | null, g_type: any, dbms_type: string | null): any;
  ...
  string_to_value(cnc: Connection | null, string: string, preferred_type: any, dbms_type: string | null): GObject.Value;
  ...
  identifier_quote(cnc: Connection, id: string, for_meta_store: boolean, force_quotes: boolean): string;
  is_busy(cnc: Connection): boolean;
  open_connection(cnc: Connection, params: QuarkList, auth: QuarkList, task_id: number, async_cb: ServerProviderAsyncCallback, cb_data: object | null): boolean;
  perform_operation(...args: any[]): any;
  render_operation(...args: any[]): any;
  rollback_savepoint(cnc: Connection, name: string): boolean;
  rollback_transaction(cnc: Connection, name: string): boolean;
  statement_execute(cnc: Connection, stmt: Statement, params: Set, model_usage: StatementModelUsage, col_types: any, last_inserted_row: Set, task_id: number, exec_cb: ServerProviderExecCallback, cb_data: object | null): GObject.Object;
  ...
  statement_to_sql(cnc: Connection, stmt: Statement, params: Set, flags: StatementSqlFlag, params_used: GLib.SList): string;
  supports_feature(...args: any[]): any;
  supports_operation(...args: any[]): any;
  unescape_string(...args: any[]): any;
  static error_quark(): GLib.Quark;
...
export class Set extends GObject.Object {
  ...
  set_holder_value(error: GLib.Error | null, holder_id: string, ...args: any[]): boolean;
  holder_attr_changed(holder: Holder, attr_name: string, attr_value: GObject.Value): void;
...
export class SqlBuilder extends GObject.Object {
  ...
  add_case(test_expr: SqlBuilderId, else_expr: SqlBuilderId, ...args: any[]): SqlBuilderId;
  add_case_v(test_expr: SqlBuilderId, else_expr: SqlBuilderId, when_array: SqlBuilderId[], then_array: SqlBuilderId[], args_size: number): SqlBuilderId;
  add_cond(op: SqlOperatorType, op1: SqlBuilderId, op2: SqlBuilderId, op3: SqlBuilderId): SqlBuilderId;
  add_cond_v(op: SqlOperatorType, op_ids: SqlBuilderId[], op_ids_size: number): SqlBuilderId;
  ...
  add_function_v(func_name: string, args: SqlBuilderId[], args_size: number): SqlBuilderId;
...
export class Statement extends GObject.Object {
  ...
  serialize(): string;
  to_sql_extended(cnc: Connection | null, params: Set | null, flags: StatementSqlFlag, params_used?: GLib.SList): string;
...
export class ThreadWrapper extends GObject.Object {
  ...
  connect_raw(instance: object | null, sig_name: string, private_thread: boolean, private_job: boolean, callback: ThreadWrapperCallback, data: object | null): number;
  disconnect(id: number): void;
  execute(func: ThreadWrapperFunc, arg: object | null, arg_destroy_func: GLib.DestroyNotify | null): number;
  execute_void(func: ThreadWrapperVoidFunc, arg: object | null, arg_destroy_func: GLib.DestroyNotify | null): number;
...
export class TreeManager extends GObject.Object {
  ...
  update_children(node: TreeNode, children_nodes: GLib.SList, out_error: boolean): GLib.SList;
  static error_quark(): GLib.Quark;
}
...
export class TreeNode extends GObject.Object {
  ...
  get_parent(): TreeNode;
  set_node_attribute(attribute: string, value: GObject.Value | null, destroy: GLib.DestroyNotify): void;
...
export class AttributesManager {
  ...
  foreach(ptr: object | null, func: AttributesManagerFunc, data: object | null): void;
  free(): void;
  get(ptr: object | null, att_name: string): GObject.Value;
  set(ptr: object | null, att_name: string, value: GObject.Value): void;
  set_full(ptr: object | null, att_name: string, value: GObject.Value, destroy: GLib.DestroyNotify): void;
  static g_new(for_objects: boolean, signal_func: AttributesManagerSignal, signal_data: object | null): AttributesManager;
}
...
export class DataHandlerIface {
  ...
  static get_value_from_sql: (dh: any, sql: string | null, type: any) => GObject.Value;
  static get_value_from_str: (dh: any, str: string | null, type: any) => GObject.Value;
...
export class DataModelIface {
  ...
  static i_get_value_at: (model: any, col: number, row: number) => GObject.Value | null;
  static i_get_attributes_at: (model: any, col: number, row: number) => ValueAttribute;
  static i_create_iter: (model: any) => DataModelIter;
  static i_iter_at_row: (model: any, iter: DataModelIter, row: number) => boolean;
  static i_iter_next: (model: any, iter: DataModelIter) => boolean;
  static i_iter_prev: (model: any, iter: DataModelIter) => boolean;
  static i_set_value_at: (model: any, col: number, row: number, value: GObject.Value) => boolean;
  static i_iter_set_value: (model: any, iter: DataModelIter, col: number, value: GObject.Value) => boolean;
  static i_set_values: (model: any, row: number, values: GLib.List | null) => boolean;
  ...
  static i_find_row: (model: any, values: GLib.SList, cols_index: number[]) => number;
  static i_set_notify: (model: any, do_notify_changes: boolean) => void;
  static i_get_notify: (model: any) => boolean;
  static i_send_hint: (model: any, hint: DataModelHint, hint_value: GObject.Value | null) => void;
...
export class DataProxyClass {
  static parent_class: GObject.ObjectClass;
  static row_delete_changed: (proxy: DataProxy, row: number, to_be_deleted: boolean) => void;
  static sample_size_changed: (proxy: DataProxy, sample_size: number) => void;
  static sample_changed: (proxy: DataProxy, sample_start: number, sample_end: number) => void;
  static validate_row_changes: (proxy: DataProxy, row: number, proxied_row: number) => GLib.Error;
  static row_changes_applied: (proxy: DataProxy, row: number, proxied_row: number) => void;
...
export class DataSelectClass {
  ...
  static fetch_random: (model: DataSelect, prow: Row, rownum: number) => boolean;
...
export class HolderClass {
  ...
  static validate_change: (holder: Holder, new_value: GObject.Value) => GLib.Error;
  static att_changed: (holder: Holder, att_name: string, att_value: GObject.Value) => void;
  static _gda_reserved1: () => void;
  static _gda_reserved2: () => void;
  static _gda_reserved3: () => void;
  static _gda_reserved4: () => void;
...
export class ServerOperationClass {
  static parent_class: GObject.ObjectClass;
  static seq_item_added: (op: ServerOperation, seq_path: string, item_index: number) => void;
  static seq_item_remove: (op: ServerOperation, seq_path: string, item_index: number) => void;
  static _gda_reserved1: () => void;
  static _gda_reserved2: () => void;
  static _gda_reserved3: () => void;
  static _gda_reserved4: () => void;
...
export class ServerProviderClass {
  ...
  static get_server_version: (provider: ServerProvider, cnc: Connection) => string;
  static supports_feature: (provider: ServerProvider, cnc: Connection | null, feature: ConnectionFeature) => boolean;
  static get_data_handler: (provider: ServerProvider, cnc: Connection, g_type: any, dbms_type: string) => any;
  static get_def_dbms_type: (provider: ServerProvider, cnc: Connection, g_type: any) => string;
  static escape_string: (provider: ServerProvider, cnc: Connection | null, str: string) => string;
  static unescape_string: (provider: ServerProvider, cnc: Connection | null, str: string) => string;
  static open_connection: (provider: ServerProvider, cnc: Connection, params: QuarkList, auth: QuarkList, task_id: number, async_cb: ServerProviderAsyncCallback, cb_data: object | null) => boolean;
  static close_connection: (provider: ServerProvider, cnc: Connection) => boolean;
  static get_database: (provider: ServerProvider, cnc: Connection) => string;
  static supports_operation: (provider: ServerProvider, cnc: Connection | null, type: ServerOperationType, options: Set | null) => boolean;
  static create_operation: (provider: ServerProvider, cnc: Connection | null, type: ServerOperationType, options: Set | null) => ServerOperation | null;
  static render_operation: (provider: ServerProvider, cnc: Connection | null, op: ServerOperation) => string | null;
  static perform_operation: (provider: ServerProvider, cnc: Connection, op: ServerOperation, task_id: number, async_cb: ServerProviderAsyncCallback, cb_data: object | null) => boolean;
  static begin_transaction: (provider: ServerProvider, cnc: Connection, name: string, level: TransactionIsolation) => boolean;
  static commit_transaction: (provider: ServerProvider, cnc: Connection, name: string) => boolean;
  static rollback_transaction: (provider: ServerProvider, cnc: Connection, name: string) => boolean;
  static add_savepoint: (provider: ServerProvider, cnc: Connection, name: string) => boolean;
  static rollback_savepoint: (provider: ServerProvider, cnc: Connection, name: string) => boolean;
  static delete_savepoint: (provider: ServerProvider, cnc: Connection, name: string) => boolean;
  static create_parser: (provider: ServerProvider, cnc: Connection | null) => SqlParser;
  static statement_to_sql: (provider: ServerProvider, cnc: Connection, stmt: Statement, params: Set, flags: StatementSqlFlag, params_used: GLib.SList) => string;
  static statement_prepare: (provider: ServerProvider, cnc: Connection, stmt: Statement) => boolean;
  static statement_execute: (provider: ServerProvider, cnc: Connection, stmt: Statement, params: Set, model_usage: StatementModelUsage, col_types: any, last_inserted_row: Set, task_id: number, exec_cb: ServerProviderExecCallback, cb_data: object | null) => GObject.Object;
  static is_busy: (provider: ServerProvider, cnc: Connection) => boolean;
  static cancel: (provider: ServerProvider, cnc: Connection, task_id: number) => boolean;
  ...
  static identifier_quote: (provider: ServerProvider, cnc: Connection, id: string, for_meta_store: boolean, force_quotes: boolean) => string;
  static handle_async: (provider: ServerProvider, cnc: Connection) => boolean;
  static statement_rewrite: (provider: ServerProvider, cnc: Connection, stmt: Statement, params: Set) => SqlStatement;
  static _gda_reserved1: () => void;
  static _gda_reserved2: () => void;
  static _gda_reserved3: () => void;
  static _gda_reserved4: () => void;
...
export class ServerProviderMeta {
  static _info: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static _btypes: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static _udt: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static udt: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, udt_catalog: GObject.Value, udt_schema: GObject.Value) => boolean;
  static _udt_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static udt_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, udt_catalog: GObject.Value, udt_schema: GObject.Value, udt_name: GObject.Value) => boolean;
  static _enums: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static enums: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, udt_catalog: GObject.Value, udt_schema: GObject.Value, udt_name: GObject.Value) => boolean;
  static _domains: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static domains: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, domain_catalog: GObject.Value, domain_schema: GObject.Value) => boolean;
  static _constraints_dom: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static constraints_dom: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, domain_catalog: GObject.Value, domain_schema: GObject.Value, domain_name: GObject.Value) => boolean;
  static _el_types: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static el_types: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, specific_name: GObject.Value) => boolean;
  static _collations: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static collations: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, collation_catalog: GObject.Value, collation_schema: GObject.Value, collation_name_n: GObject.Value) => boolean;
  static _character_sets: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static character_sets: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, chset_catalog: GObject.Value, chset_schema: GObject.Value, chset_name_n: GObject.Value) => boolean;
  static _schemata: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static schemata: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, catalog_name: GObject.Value, schema_name_n: GObject.Value) => boolean;
  static _tables_views: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static tables_views: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name_n: GObject.Value) => boolean;
  static _columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value) => boolean;
  static _view_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static view_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, view_catalog: GObject.Value, view_schema: GObject.Value, view_name: GObject.Value) => boolean;
  static _constraints_tab: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static constraints_tab: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, constraint_name_n: GObject.Value) => boolean;
  static _constraints_ref: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static constraints_ref: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, constraint_name: GObject.Value) => boolean;
  static _key_columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static key_columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, constraint_name: GObject.Value) => boolean;
  static _check_columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static check_columns: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, constraint_name: GObject.Value) => boolean;
  static _triggers: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static triggers: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value) => boolean;
  static _routines: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static routines: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, routine_catalog: GObject.Value, routine_schema: GObject.Value, routine_name_n: GObject.Value) => boolean;
  static _routine_col: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static routine_col: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, rout_catalog: GObject.Value, rout_schema: GObject.Value, rout_name: GObject.Value) => boolean;
  static _routine_par: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static routine_par: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, rout_catalog: GObject.Value, rout_schema: GObject.Value, rout_name: GObject.Value) => boolean;
  static _indexes_tab: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static indexes_tab: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, index_name_n: GObject.Value) => boolean;
  static _index_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext) => boolean;
  static index_cols: (prov: ServerProvider, cnc: Connection, meta: MetaStore, ctx: MetaContext, error: GLib.Error, table_catalog: GObject.Value, table_schema: GObject.Value, table_name: GObject.Value, index_name: GObject.Value) => boolean;
  static _gda_reserved5: () => void;
  static _gda_reserved6: () => void;
...
export class ServerProviderXa {
  static xa_start: (prov: ServerProvider, cnc: Connection, trx: XaTransactionId) => boolean;
  static xa_end: (prov: ServerProvider, cnc: Connection, trx: XaTransactionId) => boolean;
  static xa_prepare: (prov: ServerProvider, cnc: Connection, trx: XaTransactionId) => boolean;
  static xa_commit: (prov: ServerProvider, cnc: Connection, trx: XaTransactionId) => boolean;
  static xa_rollback: (prov: ServerProvider, cnc: Connection, trx: XaTransactionId) => boolean;
  static xa_recover: (prov: ServerProvider, cnc: Connection) => GLib.List;
}
export class SetClass {
  static parent_class: GObject.ObjectClass;
  static validate_holder_change: (set: Set, holder: Holder, new_value: GObject.Value) => GLib.Error;
  static validate_set: (set: Set) => GLib.Error;
  static holder_changed: (set: Set, holder: Holder) => void;
  static holder_attr_changed: (set: Set, holder: Holder, attr_name: string, attr_value: GObject.Value) => void;
...
export class SqlParserClass {
  ...
  static delim_parse: (d: object, i: number, v: GObject.Value, iface: SqlParserIface) => void;
  ...
  static parser_parse: (p: object, i: number, v: GObject.Value, iface: SqlParserIface) => void;
...
export class TreeManagerClass {
  static object_class: GObject.ObjectClass;
  static update_children: (manager: TreeManager, node: TreeNode, children_nodes: GLib.SList, out_error: boolean) => GLib.SList;
  static _gda_reserved1: () => void;
  static _gda_reserved2: () => void;
  static _gda_reserved3: () => void;
  static _gda_reserved4: () => void;
...
export class TreeNodeClass {
  ...
  static dump_children: (node: TreeNode, prefix: string, in_string: GLib.String) => void;
  static _gda_reserved1: () => void;
  static _gda_reserved2: () => void;
  static _gda_reserved3: () => void;
  static _gda_reserved4: () => void;
...
export function attributes_manager_new(for_objects: boolean, signal_func: AttributesManagerSignal, signal_data: object | null): AttributesManager;
...
export function compute_select_statement_from_update(update_stmt: Statement): SqlStatement;
export function compute_unique_table_row_condition(stsel: SqlStatementSelect, mtable: MetaTable, require_pk: boolean): SqlExpr;
export function compute_unique_table_row_condition_with_cnc(cnc: Connection | null, stsel: SqlStatementSelect, mtable: MetaTable, require_pk: boolean): SqlExpr;
...
export function rewrite_sql_statement_for_null_parameters(sqlst: SqlStatement, params: Set, out_modified: boolean | null): SqlStatement;
...
export function utility_data_model_dump_data_to_xml(model: any, parent: libxml2.NodePtr, cols: number[] | null, nb_cols: number, rows: number[] | null, nb_rows: number, use_col_ids: boolean): boolean;
export function utility_data_model_find_column_description(model: DataSelect, field_name: string): string;
export function utility_holder_load_attributes(holder: Holder, node: libxml2.NodePtr, sources: GLib.SList): boolean;
...
export function value_differ(value1: GObject.Value, value2: GObject.Value): number;
...
export function value_new_from_string(as_string: string, type: any): GObject.Value;
...
export function value_set_from_string(value: GObject.Value, as_string: string, type: any): boolean;
export function value_set_from_value(value: GObject.Value, from: GObject.Value): boolean;
export function value_set_geometric_point(value: GObject.Value, val: GeometricPoint): void;
...
export type AttributesManagerFunc = (att_name: string, value: GObject.Value, data: object | null) => void;
export type AttributesManagerSignal = (obj: GObject.Object, att_name: string, value: GObject.Value, data: object | null) => void;
export type ServerProviderAsyncCallback = (provider: ServerProvider, cnc: Connection, task_id: number, result_status: boolean, error: GLib.Error, data: object | null) => void;
export type ServerProviderExecCallback = (provider: ServerProvider, cnc: Connection, task_id: number, result_obj: GObject.Object, error: GLib.Error, data: object | null) => void;
export type SqlForeachFunc = (part: SqlAnyPart, data: object | null) => boolean;
export type SqlRenderingExpr = (expr: SqlExpr, context: SqlRenderingContext, is_default: boolean, is_null: boolean) => string;
export type SqlRenderingFunc = (node: SqlAnyPart, context: SqlRenderingContext) => string;
export type SqlRenderingPSpecFunc = (pspec: any, expr: SqlExpr | null, context: SqlRenderingContext, is_default: boolean, is_null: boolean) => string;
export type SqlRenderingValue = (value: GObject.Value, context: SqlRenderingContext) => string;
export type SqlReservedKeywordsFunc = (word: string) => boolean;
export type ThreadWrapperCallback = (wrapper: ThreadWrapper, instance: object | null, signame: string, n_param_values: number, param_values: GObject.Value, gda_reserved: object | null, data: object | null) => void;
export type ThreadWrapperFunc = (arg: object | null) => object | null;
export type ThreadWrapperVoidFunc = (arg: object | null) => void;
export type TreeManagerNodeFunc = (manager: TreeManager, parent: TreeNode, name: string) => TreeNode;
export type TreeManagerNodesFunc = (manager: TreeManager, node: TreeNode, children_nodes: GLib.SList, out_error: boolean) => GLib.SList;